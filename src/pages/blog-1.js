                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-md-12">
                            <div className="pagination-area text-center">
                                <a to="#" className="prev page-numbers">
                                    <i className='bx bx-chevrons-left'></i>
                                </a>
                                <span className="page-numbers current" aria-current="page">1</span>
                                <a to="#" className="page-numbers">2</a>
                                <a to="#" className="page-numbers">3</a>
                                <a to="#" className="page-numbers">4</a>
                                <a to="#" className="next page-numbers">
